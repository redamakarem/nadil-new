            ...
            <div class="card-header">
                ...
                <div class="card-tools">
                    <div class="input-group input-group-sm" >
                        <a href="{{route('admin.restaurants.menus.create',['restaurant' => $restaurant])}}" class="btn btn-primary">Add</a>
                    </div>
                </div>
            </div>
            <!-- /.card-header -->
                            ...
                            <td>
                                <div class="btn-group">
                                    ...
                                    <div aria-labelledby="dropdownSubMenu1" class="dropdown-menu" role="menu">
                                        ...
                                        <a class="dropdown-item" href="{{route('admin.restaurants.menus.edit',['restaurant' =>$restaurant,'id' =>$menu->id])}}">Edit</a>
                                        <a class="dropdown-item" href="#"
                                           >Delete</a>
                                        <a class="dropdown-item" href="{{route('admin.restaurants.menus.categories',['restaurant' =>$restaurant, 'id' => $menu->id])}}">Categories</a>
                                    </div>
                                </div>
                            </td>
