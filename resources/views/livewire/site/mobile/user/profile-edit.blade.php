<div class="flex flex-col space-y-8 items-center px-2">
    ...
    <div class="w-full my-2">
        <select wire:model='gender' class="flex items-center w-full ltr:font-lato rtl:font-ahlan ltr:placeholder:font-bold rtl:placeholder:font-normal text-[19px] ltr:tracking-[4px] rtl:tracking-normal uppercase border-[#707070] border-2 p-4 rounded-[19px]">
