<div class="w-full ltr:font-lato rtl:font-ahlan py-4 rounded-[19px] uppercase text-lg ltr:tracking-[4px] rtl:tracking-normal md:max-w-6xl bg-nadilBtn-100 mx-auto my-8 px-6">
    <div class="row">
        <div class="py-5"></div>
    </div>
    <div class="row">
        ...
        <div class="col-md-12">
            <div class="form-container ">
                <h2 class="ltr:font-lato rtl:font-ahlan text-center font-bold uppercase text-lg ltr:tracking-[4px] rtl:tracking-normal mb-8">{{__('nadil.user_registration.title')}}</h2>
                <form wire:submit.prevent="register">
                    <div class="mb-3">
                        @error('profile.name') <span class="danger">{{$message}}</span> @enderror

                        <input wire:model.lazy="profile.name"
                               type="text" class="w-full ltr:font-lato rtl:font-ahlan py-4 rounded-[19px] uppercase text-lg ltr:tracking-[4px] rtl:tracking-normal"
                    ...
                    <div class="mb-3">
                        ...
                        <select class="w-full ltr:font-lato rtl:font-ahlan py-4 rounded-[19px] uppercase text-lg ltr:tracking-[4px] rtl:tracking-normal" aria-label="Gender" wire:model="profile.gender">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="w-full rounded-[19px] shadow-md ltr:font-lato rtl:font-ahlan uppercase py-4" aria-label="Gender" wire:model="area">
