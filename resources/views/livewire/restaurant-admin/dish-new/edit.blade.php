    ...
    <form wire:submit.prevent="submit">
        <div class="card-body">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" wire:model='dish.name_en'>
            </div>
            @endif
            @if ($menus)
            <div class="form-group">
                <label for="name_en">Arabic Name</label>
                <input type="text" class="form-control" wire:model='dish.name_ar'>
            </div>
            @endif
            @if ($menus)
            <div class="form-group">
                <label for="name_en">English Description</label>
                <textarea type="text" class="form-control" wire:model='dish.description_en' rows="3"></textarea>
            </div>
            @endif
            @if ($menus)
            <div class="form-group">
                <label for="name_en">Arabic Description</label>
                <textarea type="text" class="form-control" wire:model='dish.description_ar' rows="3"></textarea>
            </div>
            @endif
            @if ($menus)
            <div class="form-group">
                <label for="name_en">Prep Time</label>
                <input type="text" class="form-control" wire:model='dish.prep_time'>
            </div>
            @endif
            @if ($menus)
            <div class="form-group">
                <label for="name_en">Price</label>
                <input type="text" class="form-control" wire:model='dish.price'>
            </div>
            @endif
