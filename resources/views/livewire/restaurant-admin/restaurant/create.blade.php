            ...
            <form method="POST" wire:submit.prevent="submit">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="instagram" class="form-control" id="instagram"
                            placeholder="Eg: 10 am to 11pm" wire:model.defer="form_data.opening_hours_en">
                        @error('form_data.opening_hours_en')
                            <p class="error">{{ $message }}</p>
                        @enderror
                    </div>
                    <div class="form-group">
                        ...
                        <input type="text" name="instagram" class="form-control" id="instagram"
                            placeholder="Eg: 10 am to 11pm" wire:model.defer="form_data.opening_hours_ar">
                        @error('form_data.opening_hours_ar')
                            <p class="error">{{ $message }}</p>
                        @enderror
                    </div>
                    <div class="form-group">
                        ...
                        <input type="text" name="instagram" class="form-control" id="instagram"
                            placeholder="Eg: 10 am to 11pm" wire:model.defer="form_data.weekend_opening_hours_en">
                        @error('form_data.weekend_opening_hours_en')
                            <p class="error">{{ $message }}</p>
                        @enderror
                    </div>
                    <div class="form-group">
                        <label for="instagram">Weekend Opening Hours Arabic</label>
                        <input type="text" name="instagram" class="form-control" id="instagram"
                            placeholder="Eg: 10 am to 11pm" wire:model.defer="form_data.weekend_opening_hours_ar">
                        @error('form_data.weekend_opening_hours_ar')
                            <p class="error">{{ $message }}</p>
                        @enderror
                    </div>
                    <div class="form-group">
