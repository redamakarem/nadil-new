    ...
    <div class="menu">
        ...
        <div class="menu-item">
            ...
            <div class="menu-submenu">
                ...
                <div class="menu-item">
                    <a href="{{route('restaurant-admin.users.roles',['role' => 4])}}" data-menu-path="/elements/base/badge.html" class="menu-item-link">
                        <i class="menu-item-bullet"></i>
                        <span class="menu-item-text">Rest. Super Admin</span>
                    </a>
                </div>
                <div class="menu-item">
                    <a href="{{route('restaurant-admin.users.roles',['role' => 5])}}" data-menu-path="/elements/base/breadcrumb.html" class="menu-item-link">
                        <i class="menu-item-bullet"></i>
                        <span class="menu-item-text">Rest. Admin</span>
                    </a>
                </div>
                <div class="menu-item">
                    <a href="{{route('restaurant-admin.users.roles',['role' => 6])}}" data-menu-path="/elements/base/button.html" class="menu-item-link">
                        <i class="menu-item-bullet"></i>
                        <span class="menu-item-text">Rest. Host</span>
                    </a>
                </div>
                <div class="menu-item">
                    <a href="{{route('restaurant-admin.users.roles',['role' => 7])}}" data-menu-path="/elements/base/button-group.html" class="menu-item-link">
                        <i class="menu-item-bullet"></i>
        ...
        <div class="menu-item">
            ...
            <div class="menu-submenu">
                <div class="menu-item">
                    <a href="{{route('restaurant-admin.restaurants.index')}}" data-menu-path="/elements/advanced/avatar.html" class="menu-item-link">
                        <i class="menu-item-bullet"></i>
                ...
                <div class="menu-item">
                    <a href="{{route('restaurant-admin.dishes-new.index')}}" data-menu-path="/elements/advanced/chat.html" class="menu-item-link">
                        <i class="menu-item-bullet"></i>
